...
namespace chuckstation2::vulkan {
...
bool is_instance_extension_supported(chuckstation2::instance* iris, const char* name) {
    return std::find_if(
...
bool is_instance_layer_supported(chuckstation2::instance* iris, const char* name) {
    return std::find_if(
...
bool is_device_extension_supported(chuckstation2::instance* iris, const char* name) {
    return std::find_if(
...
bool is_device_layer_supported(chuckstation2::instance* iris, const char* name) {
    return std::find_if(
...
std::vector <VkExtensionProperties> get_device_extensions(chuckstation2::instance* iris) {
    std::vector <VkExtensionProperties> extensions;
...
std::vector <VkLayerProperties> get_device_layers(chuckstation2::instance* iris) {
    std::vector <VkLayerProperties> layers;
...
VkInstance create_instance(chuckstation2::instance* iris, const instance_create_info& info) {
    ...
    iris->app_info.pApplicationName = CS2_TITLE;
    ...
    iris->app_info.apiVersion = CS2_VULKAN_API_VERSION;
...
static inline uint32_t find_memory_type(chuckstation2::instance* iris, uint32_t filter, VkMemoryPropertyFlags properties) {
...
VkDevice create_device(chuckstation2::instance* iris, const device_create_info& info) {
...
void enumerate_physical_devices(chuckstation2::instance* iris) {
    uint32_t count = 0;
...
VkPhysicalDevice find_suitable_physical_device(chuckstation2::instance* iris) {
...
int find_graphics_queue_family_index(chuckstation2::instance* iris) {
    uint32_t count = 0;
...
VkBuffer create_buffer(chuckstation2::instance* iris, VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, VkDeviceMemory& buffer_memory) {
...
void load_buffer(chuckstation2::instance* iris, VkDeviceMemory buffer_memory, void* data, VkDeviceSize size) {
    void* ptr;
...
bool copy_buffer(chuckstation2::instance* iris, VkBuffer src, VkBuffer dst, VkDeviceSize size) {
...
bool create_descriptor_pool(chuckstation2::instance* iris) {
...
bool init(chuckstation2::instance* iris, bool enable_validation) {
...
void* read_image(chuckstation2::instance* iris, VkImage src_image, VkFormat format, int width, int height) {
