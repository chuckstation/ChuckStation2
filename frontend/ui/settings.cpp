...
mapping* get_input_mapping(chuckstation2::instance* iris, int slot) {
...
const char* get_input_name(input_action action) {
    switch (action) {
        case CS2_DS_BT_SELECT: return "Select";
        case CS2_DS_BT_L3: return "L3";
        case CS2_DS_BT_R3: return "R3";
        case CS2_DS_BT_START: return "Start";
        case CS2_DS_BT_UP: return "D-pad Up";
        case CS2_DS_BT_RIGHT: return "D-pad Right";
        case CS2_DS_BT_DOWN: return "D-pad Down";
        case CS2_DS_BT_LEFT: return "D-pad Left";
        case CS2_DS_BT_L2: return "L2";
        case CS2_DS_BT_R2: return "R2";
        case CS2_DS_BT_L1: return "L1";
        case CS2_DS_BT_R1: return "R1";
        case CS2_DS_BT_TRIANGLE: return "Triangle";
        case CS2_DS_BT_CIRCLE: return "Circle";
        case CS2_DS_BT_CROSS: return "Cross";
        case CS2_DS_BT_SQUARE: return "Square";
        case CS2_DS_BT_ANALOG: return "Analog";
        case CS2_DS_AX_RIGHTV_POS: return "Right Stick Vertical+";
        case CS2_DS_AX_RIGHTV_NEG: return "Right Stick Vertical-";
        case CS2_DS_AX_RIGHTH_POS: return "Right Stick Horizontal+";
        case CS2_DS_AX_RIGHTH_NEG: return "Right Stick Horizontal-";
        case CS2_DS_AX_LEFTV_POS: return "Left Stick Vertical+";
        case CS2_DS_AX_LEFTV_NEG: return "Left Stick Vertical-";
        case CS2_DS_AX_LEFTH_POS: return "Left Stick Horizontal+";
        case CS2_DS_AX_LEFTH_NEG: return "Left Stick Horizontal-";

        case CS2_S14X_SW_DOWN: return "System 147/148 Down";
        case CS2_S14X_SW_UP: return "System 147/148 Up";
        case CS2_S14X_SW_ENTER: return "System 147/148 Enter";
        case CS2_S14X_SW_TEST: return "System 147/148 Test";
        case CS2_S14X_SW_SERVICE: return "System 147/148 Service";
        case CS2_S14X_SW_P1_START: return "System 147/148 P1 Start";
        case CS2_S14X_SW_P2_START: return "System 147/148 P2 Start";
        case CS2_S14X_SW_P3_START: return "System 147/148 P3 Start";
        case CS2_S14X_SW_P4_START: return "System 147/148 P4 Start";
    }
...
void show_system_settings(chuckstation2::instance* iris) {
...
void show_hardware_renderer_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
...
void show_graphics_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
...
void show_controller_slot(chuckstation2::instance* iris, int slot) {
    using namespace ImGui;
...
bool event_is_mod_key(const input_event& event) {
    if (event.type != CS2_EVENT_KEYBOARD) {
        return false;
    }
...
void show_mappings_editor(chuckstation2::instance* iris) {
    using namespace ImGui;
...
void show_input_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
...
void show_paths_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
...
void show_memory_card(chuckstation2::instance* iris, int slot) {
    using namespace ImGui;
...
void show_memory_card_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
...
void show_misc_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
...
#define SCHEME(str, id) \
    ...
    if (BeginCombo("##codeview_color_scheme", codeview_color_scheme_names[iris->codeview_color_scheme])) {
        ...
        SCHEME("Solarized Dark", CS2_CODEVIEW_COLOR_SCHEME_SOLARIZED_DARK);
        SCHEME("One Dark Pro", CS2_CODEVIEW_COLOR_SCHEME_ONE_DARK_PRO);
        SCHEME("Catppuccin Mocha", CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_MOCHA);
        SCHEME("Catppuccin Macchiato", CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_MACCHIATO);
        SCHEME("Catppuccin Frappé", CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_FRAPPE);

        PushFont(iris->font_small);
        TextDisabled("Light");
        PopFont();

        SCHEME("Solarized Light", CS2_CODEVIEW_COLOR_SCHEME_SOLARIZED_LIGHT);
        SCHEME("Catppuccin Latte", CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_LATTE);
...
#undef SCHEME
    ...
    if (iris->screenshot_format == CS2_SCREENSHOT_FORMAT_JPG) {
        Text("JPG Quality");
        ...
        if (iris->screenshot_jpg_quality_mode == CS2_SCREENSHOT_JPG_QUALITY_CUSTOM) {
...
const char* builtin_shader_names[] = {
    "ChuckStation2-ntsc-encoder",
    "ChuckStation2-ntsc-decoder",
    "ChuckStation2-ntsc-curvature",
    "ChuckStation2-ntsc-scanlines",
    "ChuckStation2-ntsc-noise",
};
...
void show_shader_settings(chuckstation2::instance* iris) {
    using namespace ImGui;
