...
INCBIN(iris_icon, "../res/ChuckStation2.png");
...
namespace chuckstation2::imgui {

static constexpr uint32_t DESCRIPTOR_SET_RING_SIZE = 8;

static const ImWchar g_icon_range[] = { ICON_MIN_MS, ICON_MAX_16_MS, 0 };

static bool setup_vulkan_window(chuckstation2::instance* iris, ImGui_ImplVulkanH_Window* wd, int width, int height, bool vsync) {
...
void set_theme(chuckstation2::instance* iris, int theme, bool set_bg_color) {
    // Init 'Granite' theme
...
void set_codeview_scheme(chuckstation2::instance* iris, int scheme) {
    switch (scheme) {
        default: case CS2_CODEVIEW_COLOR_SCHEME_SOLARIZED_DARK: {
        ...
        case CS2_CODEVIEW_COLOR_SCHEME_SOLARIZED_LIGHT: {
        ...
        case CS2_CODEVIEW_COLOR_SCHEME_ONE_DARK_PRO: {
        ...
        case CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_LATTE: {
        ...
        case CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_FRAPPE: {
        ...
        case CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_MACCHIATO: {
        ...
        case CS2_CODEVIEW_COLOR_SCHEME_CATPPUCCIN_MOCHA: {
...
VkShaderModule create_shader(chuckstation2::instance* iris, uint32_t* code, size_t size) {
...
VkPipeline create_pipeline(chuckstation2::instance* iris, VkShaderModule vert_shader, VkShaderModule frag_shader) {
...
bool init(chuckstation2::instance* iris) {
    ...
    init_info.ApiVersion = CS2_VULKAN_API_VERSION;
